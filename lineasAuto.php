<?php
// lineasAuto.php
// Página de línea automotriz, conectada a la base de datos.
// Las tarjetas de producto se generan automáticamente desde la BD:
// por cada "producto_slug" distinto con linea='automotriz', se muestra 1 tarjeta,
...
// Traemos 1 imagen representativa por cada producto de la línea automotriz
$sql = "SELECT a.producto_slug, a.nombre, a.ruta_thumb, a.ruta_original, p.nombre_display, p.orden_listado, p.categoria, p.grupo_filtro
        ...
        INNER JOIN (
            ...
            FROM archivos
            WHERE linea = 'automotriz' AND tipo = 'imagen' AND producto_slug IS NOT NULL AND producto_slug != ''
...
$ordenPreferido = ["Preparación", "Masilla", "Base", "Gloss", "Poliuretano"];
...
<head>
    ...
    <title>Línea Automotriz - Jhomeron</title>
            ...
            <div class="cards-row">
                <?php if (count($productos) === 0): ?>
                    <p style="font-family:'Outfit', sans-serif; padding: 20px;">
                        Aún no hay productos con línea "automotriz" y un producto_slug asignado.
