...
<?php require "header.php"; ?>
  ...
  <div class="main-content">
   ...
   <div id="asesoria-overlay" class="asesoria-overlay hidden">
    ...
    <!-- Cuadrícula con las imágenes y textos -->
    <div class="grid-container">
      <a href="lineasDecorativa.php" class="grid-item">
        <img src="imgs/lineas_produc/linea_decorativa.jpg" alt="Decorativa" />
        <div class="label-container">
          <button class="label">LÍNEA</button>
          <h2>DECORATIVA</h2>
        </div>
      </a>
      <a href="lineasAuto.php" class="grid-item">
        <img src="imgs/lineas_produc/linea_transito.jpg" alt="Automotriz" />
        <div class="label-container">
          <button class="label">LÍNEA</button>
          <h2>AUTOMOTRIZ</h2>
        </div>
      </a>
      <a href="lineaIndus.php" class="grid-item">
        <img src="imgs/lineas_produc/linea_industrial.jpg" alt="Industrial" />
        <div class="label-container">
          <button class="label">LÍNEA</button>
          <h2>INDUSTRIAL</h2>
        </div>
      </a>
      <a href="lineaMarina.php" class="grid-item">
        <img src="imgs/lineas_produc/linea_marina.jpg" alt="Marina" />
        <div class="label-container">
          <button class="label">LÍNEA</button>
          <h2>MARINA</h2>
        </div>
      </a>
      <a href="lineaTrafico.php" class="grid-item">
        <img src="imgs/lineas_produc/linea_trafico.jpg" alt="Tráfico" />
        <div class="label-container">
          <button class="label">LÍNEA</button>
          <h2>TRÁFICO</h2>
        </div>
      </a>
      <a href="lineaMadera.php" class="grid-item">
        <img src="imgs/lineas_produc/linea_madera.jpg" alt="Madera" />
        <div class="label-container">
          <button class="label">LÍNEA</button>
          <h2>MADERA</h2>
        </div>
