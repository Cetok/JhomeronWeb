...
?>
    ...
    <div class="tarjeta" style="margin-bottom: 14px; padding: 0; overflow: hidden;">
        <details>
            ...
            <label>Características (elige ícono + escribe el texto, hasta 6)</label>
            ...
            <input type="file" name="ficha_seguridad" accept="application/pdf">

            <label>Catálogo (PDF) <?php echo isset($docsExistentes["Catálogo"]) ? '<span style="color:#1ea672;">✓ ya subido</span>' : ''; ?></label>
            <input type="file" name="catalogo" accept="application/pdf">
